  ...
  return (
    <div className="container">
      <header className="loginHeader">
        ...
        <h1 style={{color: "white", marginTop: "-3px",  fontSize: "50px", marginLeft: "14px"}}>SRI SHAKTHI INSTITUTE OF ENGINEERING AND TECHNOLOGY</h1>
              </header><br />
      <div className="content">
        ...
        <div className="clg-logo">
          ...
          />
          <br />
          {nameError && <span style={{ color: "red", marginLeft: "100px" }}>{nameErrorMsg}</span>}
          <br />
          <input
            type="text"
            value={rollNo}
          ...
          />
          <br />
          {RollNoError && <span style={{ color: "red", marginLeft: "100px" }}>{RollNoErrorMsg}</span>}
          <br />
           <input
            type="text"
            value={dept}
          ...
          />
          <br />
          {deptError && <span style={{ color: "red", marginLeft: "100px" }}>{deptErrorMsg}</span>}
          <br /> 
          <input
            type="text"
            value={email}
          ...
          />
          <br />
          {emailError && <span style={{ color: "red", marginLeft: "100px" }}>{emailErrorMsg}</span>}
          <br />
          <input
            type="text"
            value={password}
          ...
          <br />
          {passwordError && (
            <span style={{ color: "red", marginLeft: "100px" }}>{passwordErrorMsg}</span>
          )}
          <br />
          ...
          className="input2" />
          <br />
          {PhoneError && (<span style={{color: "red", marginLeft: "100px"}}>{PhoneErrorMsg}</span>)}
          <br />
          <input
            type="text"
            value={role}
          ...
          <br />
          {roleeError && (
            <span style={{ color: "red", marginLeft: "100px" }}>{roleeErrorMsg}</span>
          )}
          <br />
          <input
            type="text"
          ...
          />
          <br />
          {PlacementError && <span style={{ color: "red", marginLeft: "100px" }}>{PlacementErrorMsg}</span>}
          <br /> 
          <input
            type="text"
            value={Address}
          ...
          {AddressError && <span style={{ color: "red", marginLeft: "100px" }}>{AddressErrorMsg}</span>}
          <br /> 
          <input
            type="number"
            value={sslc}
          ...
          {sslcError && <span style={{ color: "red", marginLeft: "100px" }}>{SslcErrorMsg}</span>}
          <br /> 
          <input
            type="number"
            value={hsc}
          ...
          {hscError && <span style={{ color: "red", marginLeft: "100px" }}>{hscErrorMsg}</span>}
          <br /> 
          <input
            type="text"
            value={cgpa}
          ...
          {cgpaError && <span style={{ color: "red", marginLeft: "100px" }}>{cgpaErrorMsg}</span>}
          <br /> 
          <button
            className="reg-btn"
